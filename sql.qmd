...
SELECT *
  , ("TOP LINE REVENUE" - LEAD("TOP LINE REVENUE", 1) OVER(ORDER BY "DATE" DESC)) / LEAD("TOP LINE REVENUE", 1) OVER(ORDER BY "DATE" DESC) * 100 AS "DAILY TOP LINE TREND"
  , ("BOTTOM LINE REVENUE" - LEAD("BOTTOM LINE REVENUE", 1) OVER(ORDER BY "DATE" DESC)) / LEAD("BOTTOM LINE REVENUE", 1) OVER(ORDER BY "DATE" DESC) * 100 AS "DAILY BOTTOM LINE TREND"
FROM sales_data;
```
